 ...
 * }
 */
var attempt$2 = _baseRest(function(func, args) {
  try {
...
var func$5 = convert_1('isFunction', isFunction_1, _falseOptions);

func$5.placeholder = placeholder;
var isFunction$1 = func$5;

var func$6 = convert_1('isArray', isArray_1, _falseOptions);

func$6.placeholder = placeholder;
var isArray$2 = func$6;
...
var func$7 = convert_1('once', once_1, _falseOptions);
...
var func$8 = convert_1('set', set_1);
...
var func$9 = convert_1('reduce', reduce_1);

func$9.placeholder = placeholder;
var reduce = func$9;

var func$10 = convert_1('memoize', memoize_1);

func$10.placeholder = placeholder;
var memoize$1 = func$10;
...
var func$11 = convert_1('mapValues', mapValues_1);

func$11.placeholder = placeholder;
var mapValues = func$11;
...
var composeWith = curry(function (convergeFn, ops) {
  if (isFunction$1 (ops)) {
    ops = [ops];
  }

  // type check
  if (!isFunction$1(convergeFn) ||!isArray$2(ops) ) {
    return console.error('args type incorrect, expect convergeFn is function and ops is array')
  }

  var compose = reduce(function (acc, i) {
    if (!acc) {
      return acc || i
    }
  ...
  return curryN(1, function (fn, target) { return function () {
    var args = [], len = arguments.length;
    while ( len-- ) args[ len ] = arguments[ len ];
...
var time = function (fn) { return function () {
    var args = [], len = arguments.length;
    while ( len-- ) args[ len ] = arguments[ len ];
    ...
    if (isThenable(result)) {
        return result.then(function () { return +Date.now() - begin; })
    }
    return +Date.now() - begin
}; };

var evolve = curry(function (evols) { return function (fn) { return function () {
  var args = [], len = arguments.length;
  while ( len-- ) args[ len ] = arguments[ len ];
...
var identity = curry(function (fn) { return function () {
  var args = [], len = arguments.length;
  while ( len-- ) args[ len ] = arguments[ len ];
